...
\begin{document}
    ...
    \begin{tablist}
        ...
        \item[]\tab{}Takeuchi, R., \textbf{Huang, H.}\footref{fn:eqauth}, Zhou, Y.\footref{fn:eqauth}, Kim, H., \& Zhang, Z. \enquote{3-P Framework for Workforce Management: Commentary on Han et al.’s (2026) Meta-analytic Work on High-investment HR System.} \textit{Journal of International Business Studies}.
