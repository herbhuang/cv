...
\begin{document}
    ...
    \begin{tablist}
        ...
        \item[2026]\tab{}Takeuchi, R., \textbf{Huang, H.}\footref{fn:eqauth}, Zhou, Y.\footref{fn:eqauth}, Kim, H., \& Zhang, Z. \enquote{3-P Framework for Workforce Management: Commentary on Han et al.’s (2026) Meta-Analytic Work on High-Investment HR System.} \textit{Journal of International Business Studies}. [Conditional Acceptance].
