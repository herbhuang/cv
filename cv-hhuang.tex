...
\begin{document}
    ...
    \begin{tablist}
        ...
        \item[2022]\tab{}\href{https://doi.org/10.1108/LODJ-06-2021-0312}{Hu, L., Jiang, N., \textbf{Huang, H.}, \& Liu, Y. \enquote{Competence-bonus Effects for Female Leaders: Gender Roles, Affective Trust and Leader Effectiveness.} \textit{Leadership \& Organization Development Journal}, 43(5): 719--733. }
    ...
    \begin{tablist}
        ...
        \item[ms.]\tab{}Kim, H.\footnote{\label{fn:eqauth}These authors contributed equally in this work.}, Takeuchi, R.\footref{fn:eqauth}, \textbf{Huang, H.}, \& Yun, S. [Exchange Ideology (In)congruence.] \textit{In Preparation: Journal of Applied Psychology}.

        \item[ms.]\tab{}Takeuchi, R., Shao, R., \textbf{Huang, H.}, Kim, H., \& Zhang, R. [High Investment Human Resource System and Culture Values.] %\textit{In Preparation}.

        \item[w.i.p.]\tab{}\textbf{Huang, H.}, Takeuchi, R., \& Guo, N. [Boomerang Employment and Firm Performance.] %\textit{In Preparation: Strategic Management Journal}.
