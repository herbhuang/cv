...
\begin{document}
    ...
    \begin{tablist}
        ...
        \item[ms.]\tab{}Kim, H.\footnote{\label{fn:eqauth}These authors contributed equally to this work.}, Takeuchi, R.\footref{fn:eqauth}, \textbf{Huang, H.}, \& Yun, S. [Exchange Ideology (In)congruence.] \textit{In Preparation: Journal of Applied Psychology}.
