...
%
% EB Garamond carries the body (tabular lining figures: years and dates sit
% on the same baseline as the rest of the line). Alegreya Sans carries the
% name and all three heading levels, using the family's native Bold and
