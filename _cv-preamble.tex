...
%
% Libertinus Serif carries the body. Alegreya Sans carries the name and all
% three heading levels, using the family's native Bold and Medium Italic faces.
% Keep these defaults explicit: both packages set NFSS family defaults while
% loading, and package order should not silently change the finished CV.
\usepackage[T1]{fontenc}
\usepackage[utf8]{inputenc}
\usepackage{libertinus-type1}
\usepackage{AlegreyaSans}
\renewcommand*{\rmdefault}{LibertinusSerif-TLF}
...
\makeatletter
\newcommand{\namefont}[1]{{\normalfont\cvheadfamily\bfseries\Large
